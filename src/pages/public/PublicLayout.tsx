...
export function PublicLayout({ lang, setLang, children }: {
  ...
  return (
    <div className="public-shell min-h-screen bg-cream-50 text-navy-900">
      <header className="sticky top-0 z-40 bg-cream-50/95 backdrop-blur border-b border-cream-200 px-3 sm:px-5 py-2.5">
        <div className="max-w-5xl mx-auto flex items-center gap-3 sm:gap-4">
          ...
          <nav className="hidden md:flex items-center gap-5 flex-1">
            {nav.map(n => <Link key={n.to} to={n.to} className="rounded-lg text-[14px] font-medium text-navy-600 hover:text-saffron-600">{n.label}</Link>)}
          </nav>
          <div className="ml-auto flex items-center gap-2">
            ...
            <Link to="/login" className="inline-flex min-h-[40px] items-center justify-center rounded-xl bg-saffron-500 text-navy-900 px-3 sm:px-3.5 py-2 text-[12.5px] sm:text-[13.5px] font-bold hover:bg-saffron-400">
      ...
      <footer className="border-t border-cream-200 mt-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-5 py-7 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-[12.5px] text-navy-500">
