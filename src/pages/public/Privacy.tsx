...
const copy = {
  en: {
    ...
    sections: [
      ...
      ['Platform owner access, stated plainly', 'Prangan One\u2019s own operator currently has standing access to every society\u2019s data on the platform, the same way any small software team maintaining a live product typically does at this stage. Entering a society for support is genuinely logged now, who, when, and why, not just shown on screen. We are working toward a more restricted access model itself and will update this page when that changes. Until then, treat this the way you would any vendor with administrative access to a system holding your records.'],
      ['Where your data lives', 'On Supabase (backed by Postgres, hosted in AWS Mumbai for this project). A separate demo mode (no login, for browsing the app itself) lives only in your own browser\u2019s local storage and never mixes with the real database.'],
  ...
  gu: {
    ...
    sections: [
      ...
      ['પ્લેટફોર્મ ઓનરની એક્સેસ, સ્પષ્ટ રીતે', 'Prangan One ના ઓપરેટર પાસે હાલમાં પ્લેટફોર્મ પરની દરેક સોસાયટીના ડેટાની સ્ટેન્ડિંગ એક્સેસ છે. કોઈ સોસાયટીમાં સપોર્ટ માટે પ્રવેશે ત્યારે એ ખરેખર લોગ થાય છે (કોણ, ક્યારે, શા માટે), ફક્ત સ્ક્રીન પર દેખાડેલું નથી. એક્સેસ મોડલ પોતે વધુ મર્યાદિત કરવાનું કામ ચાલુ છે, અને એ બદલાય ત્યારે આ પેજ અપડેટ કરીશું.'],
