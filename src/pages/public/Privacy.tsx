...
const copy = {
  ...
  gu: {
    title: 'પ્રાઇવસી પોલિસી', desc: 'Prangan One કયો ડેટા રાખે છે, કેવી રીતે સુરક્ષિત છે, અને આપનું નિયંત્રણ શું છે.',
    h1: 'પ્રાઇવસી પોલિસી',
    ...
    sections: [
      ...
      ['અમે તેનો ઉપયોગ કેવી રીતે કરીએ છીએ', 'અમે સોસાયટીનો ડેટા Prangan One સેવા આપવા, જાળવવા, સુરક્ષિત રાખવા, સપોર્ટ આપવા અને સેવા સંબંધિત જરૂરી સંપર્ક માટે વાપરીએ છીએ.'],
      ...
      ['પ્લેટફોર્મ ઓનરની એક્સેસ, સ્પષ્ટ રીતે', 'Prangan One ના ઓપરેટર પાસે હાલમાં પ્લેટફોર્મ પરની દરેક સોસાયટીના ડેટાની સ્ટેન્ડિંગ રીડ-એક્સેસ (વાંચવાની એક્સેસ) છે. કોઈ સોસાયટીમાં સપોર્ટ માટે પ્રવેશે ત્યારે એ ખરેખર લોગ થાય છે (કોણ, ક્યારે, શા માટે), અને એ સપોર્ટ સેશન ચાલુ હોય ત્યારે ઓપરેટરનું પોતાનું એકાઉન્ટ પણ આપની સોસાયટીના ડેટામાં કંઈ લખવાની મંજૂરી નથી ધરાવતું, આ ડેટાબેઝ લેવલે જ લાગુ છે, ફક્ત ઈન્ટરફેસમાં છુપાવેલું નથી. સ્ટેન્ડિંગ રીડ-એક્સેસ હજુ ખરેખર છે; અમે એને વધુ મર્યાદિત કરવાનું કામ ચાલુ રાખ્યું છે, અને એ બદલાય ત્યારે આ પેજ અપડેટ કરીશું.'],
      ['આપનો ડેટા ક્યાં રહે છે', 'લાઈવ એપ માટે Prangan One Supabase અને Postgres વાપરે છે. ડેમો મોડ (લોગિન વગર, એપ જોવા માટે) આપના બ્રાઉઝર સ્ટોરેજમાં રહે છે અને વાસ્તવિક ડેટાબેઝથી અલગ રહે છે.'],
