...
const copy = {
  en: {
    ...
    sections: [
      ...
      ['Who can actually see what', 'This is enforced by the database itself, not just hidden in the screen you happen to be looking at. A resident sees their own flat\u2019s bills and payments, never a neighbor\u2019s. A personal complaint is visible only to the person who filed it and your committee; a community complaint (a broken lift, say) is visible to every resident. Committee and finance roles see what their role needs to do the job. This protection currently covers flats, bills, payments, and adjustments directly at the database level; a few less sensitive areas (notices, complaints, documents) are still being moved onto the same real database and, until they are, run in a way that is not yet shared or synced across devices.'],
      ['Platform owner access, stated plainly', 'Prangan One\u2019s own operator currently has standing access to every society\u2019s data on the platform, the same way any small software team maintaining a live product typically does at this stage. We are working toward a more restricted, logged, reason-required model for this and will update this page when that change ships. Until then, treat this the way you would any vendor with administrative access to a system holding your records.'],
      ['Where your data lives', 'On Supabase (backed by Postgres, hosted in AWS Mumbai for this project) for the parts of the product already moved to a real database, and in your own browser\u2019s local storage for the parts not yet moved. Nothing about your society\u2019s data is stored on a personal device or a public spreadsheet.'],
  ...
  gu: {
    ...
    sections: [
      ...
      ['ખરેખર કોણ શું જોઈ શકે', 'આ ડેટાબેઝ લેવલે જ લાગુ છે, ફક્ત સ્ક્રીન પર છુપાવેલું નથી. રહેવાસી ફક્ત પોતાના ફ્લેટનું બિલ અને ચુકવણી જુએ, પડોશીનું ક્યારેય નહીં. વ્યક્તિગત ફરિયાદ ફક્ત ફરિયાદ કરનાર અને કમિટી જુએ; સહિયારી ફરિયાદ (જેમ કે લિફ્ટ બંધ) દરેક રહેવાસી જુએ. આ સુરક્ષા હાલમાં ફ્લેટ, બિલ, ચુકવણી, અને એડજસ્ટમેન્ટ માટે સીધી ડેટાબેઝ લેવલે લાગુ છે; થોડા ઓછા સંવેદનશીલ ભાગ (નોટિસ, ફરિયાદ, દસ્તાવેજો) હજુ એ જ ડેટાબેઝ પર ટ્રાન્સફર થઈ રહ્યા છે.'],
      ['પ્લેટફોર્મ ઓનરની એક્સેસ, સ્પષ્ટ રીતે', 'Prangan One ના ઓપરેટર પાસે હાલમાં પ્લેટફોર્મ પરની દરેક સોસાયટીના ડેટાની સ્ટેન્ડિંગ એક્સેસ છે. અમે એને વધુ મર્યાદિત, લોગ થયેલ, કારણ-જરૂરી મોડલ તરફ લઈ જવાનું કામ કરી રહ્યા છીએ અને એ બદલાય ત્યારે આ પેજ અપડેટ કરીશું.'],
      ['તમારો ડેટા ક્યાં રહે છે', 'Supabase પર (Postgres, AWS Mumbai માં હોસ્ટ થયેલ) જે ભાગ પહેલેથી ડેટાબેઝ પર ટ્રાન્સફર થયો છે એના માટે, અને તમારા બ્રાઉઝરના લોકલ સ્ટોરેજમાં જે ભાગ હજુ ટ્રાન્સફર નથી થયો એના માટે.'],
