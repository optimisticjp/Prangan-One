...
const copy = {
  ...
  gu: {
    ...
    sections: [
      ...
      ['તમારો ડેટા ક્યાં રહે છે', 'લાઈવ એપ માટે Prangan One Supabase અને Postgres વાપરે છે. ડેમો મોડ (લોગિન વગર, એપ જોવા માટે) આપના બ્રાઉઝર સ્ટોરેજમાં રહે છે અને વાસ્તવિક ડેટાબેઝથી અલગ રહે છે.'],
