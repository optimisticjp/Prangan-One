...
const copy = {
  en: {
    ...
    sections: [
      ...
      ['How we use it', 'We use society data to provide, maintain, secure, and support Prangan One for your society. We do not add resident contact details to a marketing list without asking first.'],
  ...
  gu: {
    ...
    sections: [
      ...
      ['અમે તેનો ઉપયોગ કેવી રીતે કરીએ છીએ', 'અમે સોસાયટીનો ડેટા Prangan One સેવા આપવા, જાળવવા, સુરક્ષિત રાખવા અને સપોર્ટ આપવા માટે વાપરીએ છીએ. રહેવાસીની સંપર્ક વિગત માર્કેટિંગ યાદીમાં ઉમેરતા પહેલા પરવાનગી લઈશું.'],
