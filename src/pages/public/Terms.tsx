...
const copy = {
  en: {
    ...
    sections: [
      ...
      ['Your data is yours', 'Your society controls the records it puts into Prangan One. You can use available exports for bills, payments, and member records. If you stop using the service, see our Privacy Policy for how export, deletion, and retention requests are handled after you leave.'],
  ...
  gu: {
    ...
    sections: [
      ['સેવા', 'Prangan One હાઉસિંગ સોસાયટીનું બિલિંગ, ફરિયાદ, નોટિસ અને સંબંધિત કામકાજ ચલાવવા માટેનું સોફ્ટવેર છે. સેટઅપ અમે સીધું અને વ્યક્તિગત રીતે કરીએ છીએ; આ સેલ્ફ-સર્વ સાઇનઅપ ફોર્મથી શરૂ થતી સેવા નથી.'],
      ...
      ['આપની સોસાયટીનો ડેટા', 'Prangan One માં દાખલ કરેલા રેકોર્ડ પર આપની સોસાયટીનું નિયંત્રણ છે. આપ ઉપલબ્ધ બિલ, ચુકવણી અને સભ્ય રેકોર્ડ માટેના એક્સપોર્ટ વાપરી શકો છો. સેવા બંધ કર્યા પછી એક્સપોર્ટ, ડિલીટ અને રિટેન્શન વિનંતી કેવી રીતે સંભાળાય તે માટે પ્રાઇવસી પોલિસી જુઓ.'],
      ['આપ શું સંમત થાઓ છો', 'આપ Prangan One માં ગેરકાયદેસર વસ્તુ સ્ટોર કે શેર નહીં કરો, બીજી સોસાયટીના ડેટાની એક્સેસ મેળવવાનો અથવા પ્લેટફોર્મના ઍક્સેસ કંટ્રોલને બાયપાસ કરવાનો પ્રયત્ન નહીં કરો, અને આપની સોસાયટી કોને કમિટી અથવા ફાઇનાન્સ એક્સેસ આપે છે તેની જવાબદારી આપની સોસાયટીની રહેશે.'],
      ['અમે હજુ શું બનાવી રહ્યા છીએ', 'Prangan One વિકસતું પ્રોડક્ટ છે, પૂર્ણ અને સ્થિર સિસ્ટમ નહીં. માર્કેટિંગમાં વર્ણવાયેલી કેટલીક ક્ષમતાઓ, જેમ કે વધુ સંપૂર્ણ સર્વર-એનફોર્સ્ડ ઓડિટ લોગ અથવા સંપૂર્ણ સ્વતંત્ર ફાઇનાન્સ ભૂમિકા, તબક્કાવાર બને છે અને દરેક એકાઉન્ટ પર પહેલે દિવસે લાઈવ હોય જ એવું નથી. કોઈ ક્ષમતા ખરેખર પૂર્ણ થાય ત્યાર પછી જ અમે તેને પૂર્ણ ગણાવીશું.'],
      ['અમારી જવાબદારીની મર્યાદા', 'Prangan One આપની સોસાયટીનું કામકાજ સરળ બનાવવાનું સાધન છે; લાગુ હાઉસિંગ સોસાયટી કાયદા હેઠળ આપની સોસાયટીની પોતાની કાનૂની, નાણાકીય અથવા વૈધાનિક પાલન જવાબદારીઓનો વિકલ્પ નથી. એપના ડેટા પરથી કમિટી લેતા નિર્ણયો અથવા આપની સોસાયટીએ આપેલી એક્સેસના દુરુપયોગથી થનારા નુકસાન માટે અમે જવાબદાર નથી.'],
      ['શરતોમાં ફેરફાર', 'આ શરતોમાં મહત્વનો ફેરફાર થશે તો અમે આ પેજ અપડેટ કરીશું અને ફેરફાર નોંધપાત્ર હોય ત્યારે સોસાયટીના એડમિનને યોગ્ય રીતે જાણ કરવાનો પ્રયત્ન કરીશું.'],
