...
const copy = {
  ...
  gu: {
    ...
    items: [
      ...
      ['કમિટી બદલાય તો શું થાય?', 'રેકોર્ડ ખરેખરા ડેટાબેઝમાં રહે છે, કોઈ એક કમિટી મેમ્બરના ફોન કે લેપટોપ પર નહીં, એટલે પહેલાનું કંઈ ખોવાય નહીં. નવા એડમિનને આપની કમિટી તરફથી યોગ્ય એક્સેસ મળે.'],
    ],
  },
}
