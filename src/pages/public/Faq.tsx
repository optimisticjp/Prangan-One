...
const copy = {
  en: {
    ...
    items: [
      ...
      ['Is our data private from other societies?', 'Yes, for the parts that matter most. Flats, bills, payments, and adjustments are enforced at the database level, every society only ever sees its own, and a resident only ever sees their own flat\u2019s bills, never a neighbor\u2019s. A few less sensitive areas (notices, complaints, that kind of thing) are still being moved over, and until they are, they run locally rather than being shared across anyone.'],
  ...
  gu: {
    ...
    items: [
      ...
      ['અમારો ડેટા બીજી સોસાયટીથી અલગ છે?', 'હા, જે સૌથી અગત્યનું છે એના માટે. ફ્લેટ, બિલ, ચુકવણી અને એડજસ્ટમેન્ટ ડેટાબેઝ લેવલે જ સુરક્ષિત છે, દરેક સોસાયટી ફક્ત પોતાનું જ જુએ, અને રહેવાસી ફક્ત પોતાના ફ્લેટનું બિલ જુએ, પડોશીનું ક્યારેય નહીં. થોડા ઓછા સંવેદનશીલ ભાગ (નોટિસ, ફરિયાદ જેવા) હજુ ટ્રાન્સફર થઈ રહ્યા છે, અને જ્યાં સુધી ના થાય ત્યાં સુધી એ સ્થાનિક રીતે જ ચાલે છે, કોઈની સાથે શેર થયા વગર.'],
