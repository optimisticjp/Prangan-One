...
const copy = {
  en: {
    ...
    items: [
      ...
      ['How long is the free trial, and do we need a card?', '90 days, full access, every module. No card at all to start. The 90 days begins once your society is actually set up and ready to use, not the day you first reach out.'],
      ['Is our data private from other societies?', 'Yes, enforced at the database level, not just hidden on screen. Every society only ever sees its own flats, bills, payments, complaints, notices, documents, and everything else, and a resident only ever sees their own flat\u2019s bills, never a neighbor\u2019s.'],
      ...
      ['What happens when our committee changes?', 'Records live in a real database, not on any one committee member\u2019s phone or laptop, so nothing from before is lost. The new admin gets real access, granted by your committee.'],
    ],
  },
  gu: {
    ...
    items: [
      ...
      ['ફ્રી ટ્રાયલ કેટલા દિવસનો છે, કાર્ડ જોઈએ?', '90 દિવસ, પૂરો એક્સેસ, દરેક મોડ્યુલ. શરૂ કરવા કાર્ડની જરૂર જ નથી. 90 દિવસ ત્યારે શરૂ થાય જ્યારે તમારી સોસાયટી ખરેખર સેટ થઈને વાપરવા તૈયાર થાય, તમે પહેલો સંપર્ક કરો એ દિવસે નહીં.'],
      ['અમારો ડેટા બીજી સોસાયટીથી અલગ છે?', 'હા, ડેટાબેઝ લેવલે જ સુરક્ષિત છે, ફક્ત સ્ક્રીન પર છુપાવેલું નથી. દરેક સોસાયટી ફક્ત પોતાના ફ્લેટ, બિલ, ચુકવણી, ફરિયાદ, નોટિસ, દસ્તાવેજો અને બાકી બધું જુએ, અને રહેવાસી ફક્ત પોતાના ફ્લેટનું બિલ જુએ, પડોશીનું ક્યારેય નહીં.'],
      ...
      ['કમિટી બદલાય તો શું થાય?', 'રેકોર્ડ ખરેખરા ડેટાબેઝમાં રહે છે, કોઈ એક કમિટી મેમ્બરના ફોન કે લેપટોપ પર નહીં, એટલે પહેલાનું કંઈ ખોવાય નહીં. નવા એડમિનને તમારી કમિટી તરફથી ખરેખરી એક્સેસ મળે.'],
    ],
  },
}
