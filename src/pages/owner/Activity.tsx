  ...
  return (
    <div>
      ...
      <Card className="mb-4">
        ...
        <TableWrap>
          <thead><tr><th className={th}>સોસાયટી</th><th className={th}>મોડ</th><th className={th}>શરૂ</th><th className={th}>પૂરું</th></tr></thead>
          <tbody>
            ...
            {impersonations.length === 0 && <tr><td className={td} colSpan={4}>હજુ કોઈ impersonation સેશન નથી.</td></tr>}
          </tbody>
        </TableWrap>
      </Card>
