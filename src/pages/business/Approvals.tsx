...
export default function BusinessApprovals(){
 ...
 return <div className="space-y-3">
  <div><h1 className="text-[17px] font-bold text-navy-900">Expense review</h1><p className="text-[11.5px] text-navy-400">Partner accountability without pretending already-spent money is still waiting for permission.</p></div>
  <div className="rounded-xl bg-navy-50 border border-navy-100 px-3 py-2.5 flex gap-2 text-[11px] text-navy-600"><ShieldCheck size={16} className="text-navy-600 shrink-0 mt-0.5"/><div><strong>Review and payment are separate.</strong> A PAID expense may already have moved money. Accepting confirms the record; flagging marks it for attention. A TO PAY expense can also be reviewed before settlement.</div></div>
