...
const tools = [
  ...
  { to: '/business/money-map', icon: MapPinned, title: 'Money overview', sub: 'How much we have, where it is, who owes us and who we owe' },
  { to: '/business/accounts', icon: Banknote, title: 'Cash, bank & UPI', sub: 'Where business money is kept, including money with a partner' },
  { to: '/business/recurring', icon: Repeat2, title: 'Regular payments', sub: 'Save rent, subscriptions and other entries you repeat often' },
  { to: '/business/categories', icon: Tags, title: 'Categories', sub: 'Edit or delete income and expense labels' },
  { to: '/business/day-close', icon: CalendarCheck2, title: 'Count cash', sub: 'Check actual cash against what Prangan expects' },
  { to: '/business/import', icon: Upload, title: 'Bank statement', sub: 'Import a CSV and review entries before saving' },
  { to: '/business/reports', icon: BarChart3, title: 'Reports / CA export', sub: 'Simple monthly numbers plus CSV for your accountant' },
