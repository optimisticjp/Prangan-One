...
export default function BusinessSettings(){
 ...
 return <div className="space-y-3 min-w-0">
  <div><h1 className="text-[17px] font-bold text-navy-900">Business settings</h1><p className="text-[11.5px] text-navy-400">Workspace name and simple expense-review rules.</p></div>
  <div className="rounded-xl border border-cream-200 bg-white p-3 space-y-3">
   ...
   <Field label="Expense review rule" hint="Review is accountability after an expense is recorded. It does not pretend money has not moved."><Select value={reviewMode} onChange={e=>setReviewMode(e.target.value as ReviewMode)} disabled={!canAdmin}><option value="none">No partner review required</option><option value="one">One partner above an amount</option><option value="tiered">One partner above X, all partners above Y</option><option value="all">Every expense needs all other partners</option></Select></Field>
